...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fdanish-data-protection-mcp.svg)](https://www.npmjs.com/package/@ansvar/danish-data-protection-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/danish-data-protection/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add danish-data-protection-mcp --transport http https://mcp.ansvar.eu/danish-data-protection/mcp` |
...
```json
{
  "mcpServers": {
    "danish-data-protection-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/danish-data-protection/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/danish-data-protection-mcp
```
...
```json
{
  "mcpServers": {
    "danish-data-protection-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/danish-data-protection-mcp"]
    }
  }
}
```
